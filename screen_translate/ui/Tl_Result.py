...
class Detached_Tl_Result():
    ...
    def __init__(self):
        ...
        self.textBoxTlResult = TextWithVar(self.tbFrame, textvariable=globalStuff.text_Box_Top_Var, height = 5, width = 100, font=("Segoe UI", 10), yscrollcommand=True, background=self.textboxBgColor.get())
