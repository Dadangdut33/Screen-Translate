...
class Detached_Tl_Result():
    ...
    def __init__(self):
        ...
        # textbox font label
        self.tbQueryFont = settings['Result_Box']['font']
        ...
        self.textBoxTlQuery = TextWithVar(self.tbFrame, textvariable=globalStuff.text_Box_Bottom_Var, height = 5, width = 100, yscrollcommand=True, background=self.textboxBgColor.get())
...
#         # Textbox in topframe2
#         self.textBoxTlResult = TextWithVar(self.tbFrame, textvariable=globalStuff.text_Box_Bottom_Var, height = 5, width = 100, font=("Segoe UI", 10), yscrollcommand=True, background=self.textboxBgColor.get())
