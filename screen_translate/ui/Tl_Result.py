...
class Detached_Tl_Result():
    ...
    def __init__(self):
        self.root = Tk()
        self.root.title('Translation Results')
        ...
        self.textBoxTlResult = TextWithVar(self.topFrame, textvariable=globalStuff.text_Box_Bottom_Var, height = 5, width = 100, font=("Segoe UI", 10), yscrollcommand=True)
